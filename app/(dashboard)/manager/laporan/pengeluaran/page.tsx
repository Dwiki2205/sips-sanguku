...
export default function LaporanPengeluaranPage() {
  ...
  const downloadExcel = async () => {
    try {
      ...
      //  - XLSX types will be loaded at runtime
  ...
  // Tambahkan tombol PDF download ke UI
          ...
          <div className="flex justify-between items-start mb-6">
            ...
            <div className="flex gap-3">
              ...
              <button 
                ...
                className="px-6 py-2.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors flex items-center gap-2 font-medium shadow-md"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button 
                ...
                className="px-6 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors flex items-center gap-2 font-medium shadow-md"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
